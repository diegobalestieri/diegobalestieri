...
<h3 align="left">Some projects I worked at:</h3>
<h4 align="left">Micro Machines:</h4>
Racing game made in C++ and using SDL.

- <a href="https://github.com/diegobalestieri/MicroMachines" target="_top">link to repository</a>

<h4 align="left">Seedy Fiuba:</h4>
KickStarter like application build using React, React Native, Python and Java Script, this application was build using MicroServices and had two frontend application one mobile and the other one web for administration purposes. 

- [link to web app](https://github.com/Seedy-Fiuba-Grupo-5/Backoffice-web)

- [link to mobile app](https://github.com/Seedy-Fiuba-Grupo-5/App-mobile)

- [link to projects backend](https://github.com/Seedy-Fiuba-Grupo-5/Backend-projects)

- [link to payments backend](https://github.com/Seedy-Fiuba-Grupo-5/Backend-users)

- [link to users backend](https://github.com/Seedy-Fiuba-Grupo-5/Gateway)

- [link to gateway](https://github.com/Seedy-Fiuba-Grupo-5/Backend-payments-sc)
